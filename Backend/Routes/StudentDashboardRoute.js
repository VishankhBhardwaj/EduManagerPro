...
const { studentData,UpdateStudentData,AllTeachers,StudyRequests,FetchStudyRequestsStatusForStudent,Attendence,getStudentAttendance,studentWork,allAssignments } = require('../Controllers/DashboardController');
